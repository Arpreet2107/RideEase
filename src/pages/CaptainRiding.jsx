...
const CaptainRiding = () => {
    ...
    // Use useEffect to handle GSAP animations
    useEffect(() => {
        if (finishRidePanel) {
            gsap.to(finishRidePanelRef.current, {
                transform: 'translateY(0)',
                duration: 0.5, // Optional: Add duration for smoother transition
            });
        } else {
            gsap.to(finishRidePanelRef.current, {
    ...
    }, [finishRidePanel]); // Dependency array to trigger animation when finishRidePanel changes
    ...
    return (
        <div className="h-screen relative flex flex-col justify-end">
            ...
            {/* Ride Information and Complete Ride Button */}
            <div
